          ...
          Transform.translate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(2.0),
                color: const Color(0xffffffff),
                border: Border.all(width: 1.0, color: const Color(0xff3b92f6)),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(81.5, 261.5),
            child: SvgPicture.string(
              _svg_hj072f,
              allowDrawingOutsideViewBox: true,
            ),
...
const String _svg_oebsah =
    '<svg viewBox="28.0 224.0 315.0 282.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="20"/></filter></defs><path transform="translate(28.0, 224.0)" d="M 8 0 L 307 0 C 311.4182739257813 0 315 2.805681705474854 315 6.266665458679199 L 315 275.7332458496094 C 315 279.1942749023438 311.4182739257813 281.9999694824219 307 281.9999694824219 L 8 281.9999694824219 C 3.581722259521484 281.9999694824219 0 279.1942749023438 0 275.7332458496094 L 0 6.266665458679199 C 0 2.805681705474854 3.581722259521484 0 8 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
...
const String _svg_hj072f =
    '<svg viewBox="81.5 261.5 1.0 85.0" ><path transform="translate(81.5, 261.5)" d="M 0 0 L 0 25" fill="none" fill-opacity="0.1" stroke="#707070" stroke-width="1" stroke-opacity="0.1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(81.5, 321.5)" d="M 0 0 L 0 25" fill="none" fill-opacity="0.1" stroke="#707070" stroke-width="1" stroke-opacity="0.1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
