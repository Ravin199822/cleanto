...
class _MyBooking_2 extends StatelessWidget {
  _MyBooking_2({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_dz511r =
    '<svg viewBox="147.0 119.0 82.0 1.0" ><path transform="translate(147.0, 119.0)" d="M 0 0 L 82 0" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
