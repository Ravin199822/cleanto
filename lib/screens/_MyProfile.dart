...
const String _svg_mz5eke =
    '<svg viewBox="0.0 0.0 375.0 240.7" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="10"/></filter></defs><path transform="translate(0.0, 100.0)" d="M 0 0 L 375 0 L 375 140.743896484375 L 0 140.743896484375 L 0 0 Z" fill="#3c94f8" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/><path  d="M 0 0 L 375 0 L 0 0 Z" fill="#181820" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="10"/></filter></defs><path  d="M 0 0 L 375 0 L 375 100 L 0 100 L 0 0 Z" fill="#3c94f8" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
...
const String _svg_qh0awx =
    '<svg viewBox="0.0 100.0 375.0 140.7" ><defs><pattern id="image" patternUnits="userSpaceOnUse" width="5000.0" height="3328.0"><image xlink:href="null" x="0" y="0" width="5000.0" height="3328.0" /></pattern></defs><path transform="translate(0.0, 100.0)" d="M 0 0 L 375 0 L 375 140.743896484375 L 0 140.743896484375 L 0 0 Z" fill="url(#image)" fill-opacity="0.15" stroke="none" stroke-width="1" stroke-opacity="0.15" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
